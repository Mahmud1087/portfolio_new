...
const Hero = () => {
  ...
  return (
    <div
      ref={ref}
      className='mt-40 h-fit relative grid place-items-center'
      id='#'
    >
      ...
      <section className='w-1/2 m-auto grid place-items-center gap-8 relative'>
        ...
        <aside className='flex gap-4 items-center'>
          <a
            className=' bg-gray-950 rounded-full w-fit flex items-center gap-4 py-[10px] px-6 text-gray-50 hover:scale-110 transition-all delay-75'
            href='#contact'
          >
